      ...
      <div className="w-full p-2 bg-white fixed top-0 shadow-xl border-1 border-b-gray-300 flex items-center justify-between z-2">
        ...
        <div className="flex flex-col md:flex-row gap-3">
          ...
          <input
            ...
            required
            autoComplete="email"
            className="block w-full rounded-md bg-white/5 px-3 text-base text-black outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-black/50 sm:text-sm/6 border-1 border-gray-300"
          ...
          <button
            type="button"
            className="w-full text-white py-1 px-4 rounded-md cursor-pointer hover:scale-105 transition-scale duration-150"
            onClick={() => {
              handleLimit(val);
              handleGenerateButton();
              handledegree(degree);
